...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/d_movie_office')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/d_movie_office')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '')).split()]  #id channel
...
URL = "https://doffice.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://doffice.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://doffice.onrender.com".format(FQDN)
else:
    URL = "https://doffice.onrender.com/".format(FQDN)
